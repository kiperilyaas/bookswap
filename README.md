...
# Tutte le modifiche facciamo solo su nostri rami, e dopo aver finito mandiamo la richesta per modificare il main
...
git commit -m " nome del snapshot " --> server per fare un snapshot per mandare dopo sul main. Di solito si scrive in modo genarale cosa e' stato aggiunto.
